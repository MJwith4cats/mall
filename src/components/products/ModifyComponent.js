    ...
    return (
        <div className="border-2 border-sky-200 mt-10 m-2 p-4">
                ...
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    ...
                    <div className="w-4/5 justify-center flex flex-wrap items-start">
                        {product.uploadFileNames.map((imgFile, i)=>
                            ...
                            key={i}>
                                <button className="bg-blue-500 text-3xl text-white" onClick={() => deleteOldImages(imgFile)}>
                                      DELETE
                                </button>
            ...
            <div className="flex justify-end p-4">
                ...
                <button type="button" className="inline-block rounded p-4 text-xl w-32 text-white bg-orange-500"
                onClick={handleClickModify}>Modify</button>
                <button type="button" className="rounded p-4 text-xl w-32 text-white bg-blue-500"
